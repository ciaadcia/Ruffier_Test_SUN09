...
txt_next = 'Start'
txt_instruction = ('This application allows you to use Ruffier test to make an initial diagnosis of your health. \n'
                   'The Ruffiesr test is a set of physical exercises designed to assess your cardiac performance during physical exertion. \n'
                   ...
                   'When the exercise ends, the ubject lies down and their pulse measured again for the first 15 seconds\n'
...
txt_hintage = '0'
txt_test1 = 'Lie on your back and take your pulse for 15 seconds. Click the "Start first test" button to start the timer. \write down the result in the appropriate field.'
txt_test2 = 'Perform 30 squats in 45 seconds. To do this, click the "Start doing squats" button\n to start the squat counter'
txt_test3 = 'Lie on your back and take your pulse for the first 15 seconds of the minute, the for the last 15 seconds of the minute.' \
'n\Press the "Start final test" button to start the timer. \nThe seconds that should be measured are indicated in green and the minutes that should not be measured are indicated in black, ' \
